...
{
    [TestFixture]
    public class JaggedArrayInterfaceHelper_Tests
    {
        [Test]
        ...
        [Test]
        public void Can_BubbleSort_By_Sums_Ascending_Via_Comparison()
        {
            int[][] actual = new int[8][];
        ...
        public void BubbleSort_Throws_ArgumentNullException_If_JaggedArray_Is_Null() =>
            Assert.Throws<ArgumentNullException>(() => JaggedArrayInterfaceHelper.BubbleSort(null, new MaxValueComparer()));
